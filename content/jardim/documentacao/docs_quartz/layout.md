...
| Layout                          | Preview                             |
| ------------------------------- | ----------------------------------- |
| Desktop (width > 1200px)        | ![[content/redearte/jardim/documentacao/docs_quartz/images/quartz-layout-desktop.png\|800]] |
| Tablet (800px < width < 1200px) | ![[content/redearte/jardim/documentacao/docs_quartz/images/quartz-layout-tablet.png\|800]]  |
| Mobile (width < 800px)          | ![[content/redearte/jardim/documentacao/docs_quartz/images/quartz-layout-mobile.png\|800]]  |
...
See [a list of all the components](content/redearte/jardim/documentacao/docs_quartz/tags/component.md) for all available components along with their configuration options. You can also checkout the guide on [[content/redearte/jardim/documentacao/docs_quartz/advanced/creating components]] if you're interested in further customizing the behaviour of Quartz.
...
Most meaningful style changes like colour scheme and font can be done simply through the [[content/redearte/jardim/documentacao/docs_quartz/configuration#General Configuration|general configuration]] options. However, if you'd like to make more involved style changes, you can do this by writing your own styles. Quartz 4, like Quartz 3, uses [Sass](https://sass-lang.com/guide/) for styling.
