...
- `BuildCtx` is defined in `quartz/ctx.ts`. It consists of
  ...
  - `cfg`: The full Quartz [[docs/configuration]]
  - `allSlugs`: a list of all the valid content slugs (see [[content/redearte/jardim/documentacao/docs_quartz/advanced/paths]] for more information on what a `ServerSlug` is)
...
A good example of a transformer plugin that borrows from the `remark` and `rehype` ecosystems is the [[content/redearte/jardim/documentacao/docs_quartz/plugins/Latex|Latex]] plugin:
...
- Your component should use `getQuartzComponents` to declare a list of `QuartzComponents` that it uses to construct the page. See the page on [[content/redearte/jardim/documentacao/docs_quartz/advanced/creating components]] for more information.
